...
/obj/item/mop/proc/clean(turf/A)
	if(reagents.has_reagent(/datum/reagent/water, 1) || reagents.has_reagent(/datum/reagent/water/dwater, 1) || reagents.has_reagent(/datum/reagent/water/bwater, 1) || reagents.has_reagent(/datum/reagent/water/purified, 1) || reagents.has_reagent(/datum/reagent/water/holywater, 1) || reagents.has_reagent(/datum/reagent/consumable/ethanol/vodka, 1) || reagents.has_reagent(/datum/reagent/abraxo_cleaner, 1))
