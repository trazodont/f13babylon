...
/obj/item/storage/crayons/Initialize(mapload)
	...
	STR.max_items = 7
	CANHOLD_STATIC(STR, typecacheof(list(/obj/item/toy/crayon)))
...
/obj/item/toy/crayon/spraycan/isValidSurface(surface)
	return (istype(surface, /turf/open/floor) || istype(surface, /turf/closed/wall) || istype(surface, /turf/open/indestructible/ground))
