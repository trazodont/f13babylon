...
#define isrobotic(A) (is_species(A, /datum/species/ipc) || is_species(A, /datum/species/synth) ||is_species(A, /datum/species/synthliz) || is_species(A, /datum/species/synthanthro))
