...
// /obj/item/projectile/rocket signals
#define COMSIG_ROCKET_IMPACT "rocket_impact"					//called in /obj/item/projectile/rocket/on_hit (user, target, params, zone_override)
