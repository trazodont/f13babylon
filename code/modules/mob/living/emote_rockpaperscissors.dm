...
/mob/living/carbon/human/proc/beginRockPaperScissors(chosen_move)
	...
	do_after_advanced(
		src,
		ROCKPAPERSCISSORS_TIME_LIMIT,
		src,
		DO_AFTER_REQUIRES_USER_ON_TURF|DO_AFTER_NO_COEFFICIENT|DO_AFTER_NO_PROGRESSBAR|DO_AFTER_DISALLOW_MOVING_ABSOLUTE_USER,
		CALLBACK(src, PROC_REF(rockpaperscissors_tick)),
	)
