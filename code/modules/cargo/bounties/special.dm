...
/datum/bounty/item/saturnite
	name = "Saturnite"
	description = "Big MT's experimental materials division is in desparate need for Saturnite. Send them a large shipment and we'll make it worth your while."
	reward = 15000
	required_count = 10
	wanted_types = list(/obj/item/stack/sheet/mineral/saturnite)
