/obj/item/seeds/mutfruit
	...
	production = 5
	maturation = 5
	reagents_add = list(/datum/reagent/consumable/nutriment/vitamin = 0.05, /datum/reagent/water = 0.075, /datum/reagent/consumable/nutriment = 0.075, /datum/reagent/radium = 0.15)
