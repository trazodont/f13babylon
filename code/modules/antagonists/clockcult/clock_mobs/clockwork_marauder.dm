...
/mob/living/simple_animal/hostile/clockwork/marauder/guardian/Initialize(mapload)
	. = ..()
...
/mob/living/simple_animal/hostile/clockwork/marauder/guardian/proc/update_stats()
	if(GLOB.ratvar_awakens)
		...
		switch(healthpercent)
			if(70 to INFINITY) //Bonuses to speed and damage at high health
				speed = 0
			...
			if(-INFINITY to 9) //We are super weak and going to die
				speed = 4
