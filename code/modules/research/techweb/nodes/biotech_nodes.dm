...
/datum/techweb_node/adv_biotech
	...
	design_ids = list("crewpinpointer", "smoke_machine", "plasmarefiller", "limbgrower", "meta_beaker", "healthanalyzer_advanced", "harvester", "holobarrier_med", "defibrillator_compact", "pHmeter", "containmentbodybag", "bluespacebodybag")
