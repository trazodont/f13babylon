/datum/techweb_node/blueprinted_bottles
	...
	starting_node = TRUE
	design_ids = list("gin", "wine", "whiskey", "vodka", "tequila", "patron", "rum", "kahlua", "vermouth", "goldschlager", "hcider", "cognac", "absinthe", "grappa", "sake", "fernet", "applejack", "champagne", "trappist", "grenadine", "autobottler")
